...
const FormCheckboxController = (props) => {
...
FormCheckboxController.propTypes = {
...
FormCheckboxController.defaultProps = {
  path: undefined,
...
export default connect(mapStateToProps)(FormCheckboxController)
